...
export default function Hero() {
	...
	return (
		<section className="relative w-full max-w-[1440px]  mx-auto px-3 pt-3 sm:pt-10  sm:px-10 ">
			<div className="w-full h-[250px] mx-auto px-3 rounded-md bg-white sm:px-6 ">
				<div className="relative flex flex-col w-full lg:h-[200px] justify-between -bottom-40 left-1/2 divide-solid divide-y-2 md:divide-y-0 md:divide-x-2 transform -translate-x-1/2 px-7 md:py-7 md:px-0 rounded-md bg-primary-content md:flex-row ">
					{/* Photo Title Section */}
					<div className="relative flex flex-col items-center md:flex-row md:items-start py-7 md:px-7 md:py-0 gap-x-7 ">
						<Image
							...
							width={1000}
							height={1000}
							className=" w-[200px] h-[200px] absolute md:relative object-cover rounded-md shadow-sm border-[4px] border-background -top-20"
						/>
